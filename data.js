...
// STEP 5: 메시지의 존댓말/반말 여부 (기본값은 '반말')
// - relation이 'boss'(직장 상사·어려운 동료)이면 이 선택과 무관하게 무조건 '존댓말'로 강제됨
//   (app.js의 updateSpeechConstraint, matching.js의 buildMessage 참고)
const SPEECH_LEVELS = ['반말', '존댓말'];

/* ============ 태그별 × 톤별 × 존댓말/반말별 멘트 풀 ============
   구조: TAG_CONTEXTS[태그][톤][존댓말/반말] = 문구 배열
   - matching.js의 buildMessage()가 선물의 첫 번째 tag, 사용자가 고른 톤,
     그리고 존댓말/반말 여부(강제 존댓말 포함)로 이 배열에서 랜덤으로
     하나를 뽑아 카드 메시지를 만든다.
   - 새 태그를 추가하려면: 여기에 4개 톤 × 2개 존댓말/반말, 총 8개 배열
     각각 최소 1개 이상의 문구를 채워 넣어야 buildMessage의 폴백 로직이
     안전하게 동작한다. */
const TAG_CONTEXTS = {
  '뷰티': {
    '다정하게': {
      '반말': ['너한테 잘 어울릴 것 같아서 골라봤어. 잘 써줘ㅎㅎ', '요즘 이런 거 필요할 것 같아서 골라봤어ㅎㅎ', '소소하지만 네 마음에 쏙 들었으면 좋겠어 :)'],
      '존댓말': ['잘 어울리실 것 같아서 골라봤어요. 잘 써주세요ㅎㅎ', '요즘 필요하실 것 같아서 준비해봤어요ㅎㅎ', '소소하지만 마음에 쏙 드셨으면 좋겠어요 :)']
    },
    '담백하게': {
      '반말': ['매일 쓰기 무난한 걸로 골랐어.', '피부 관리할 때 쓰기 좋을 거야.', '실용적인 뷰티 아이템으로 챙겼어.'],
      '존댓말': ['매일 쓰기 무난한 걸로 골랐어요.', '피부 관리하실 때 쓰기 좋을 거예요.', '실용적인 뷰티 아이템으로 준비했어요.']
    },
    '장난스럽게': {
      '반말': ['이거 바르고 더 예뻐져라/멋있어져라ㅋㅋ', '이거 쓰고 갑자기 연예인 되는 거 아니야?ㅋㅋ', '이제 관리 좀 열심히 하자ㅋㅋ'],
      '존댓말': ['이거 바르시고 더 예뻐지실 것 같아요!!', '이거 쓰시면 연예인 되시는 거 아니에요??ㅎㅎ', '이참에 관리 살짝 즐겨보시는 거 어때요??']
    },
    '격식있게': {
      '존댓말': ['일상의 소소한 가꾸움에 도움이 되길 바랍니다.', '소소하지만 기분 좋은 선물이 되었으면 좋겠습니다.', '평소에도 유용하게 잘 사용하셨으면 좋겠습니다.']
    }
  },
  '향': {
    '다정하게': {
      '반말': ['좋은 향기 맡으면서 기분 전환했으면 좋겠어!', '공간이 더 은은하고 따뜻해지길 바라며 준비했어!', '향이 너무 좋아서 네 생각나서 골랐어 :)'],
      '존댓말': ['좋은 향기 맡으면서 기분 전환하셨으면 좋겠어요!', '공간이 더 은은하고 따뜻해지길 바라며 준비했어요!', '향이 너무 좋아서 생각나서 골랐어요 :)']
    },
    '담백하게': {
      '반말': ['기분 전환할 때 피우거나 쓰기 좋을 거야.', '향이 무난하고 괜찮아서 골랐어.', '공간 분위기 바꿀 때 써봐.'],
      '존댓말': ['기분 전환하실 때 쓰기 좋을 거예요.', '향이 무난하고 괜찮아서 골랐어요.', '공간 분위기 바꾸실 때 써보세요.']
    },
    '장난스럽게': {
      '반말': ['이제 지나갈 때마다 좋은 냄새 나겠네ㅋㅋ', '이거 쓰고 향수 뭐 쓰냐는 말 좀 들어봐라ㅋㅋ', '이거 뿌리고 향기로운 사람 좀 되어봐라ㅋㅋ'],
      '존댓말': ['이제 지나가실 때마다 좋은 냄새 나실 것 같아요!!', '이거 쓰시면 향수 뭐 쓰시냐는 말 들으실지도 몰라요!!', '이거 뿌리시고 향기로운 분 되시길 바랍니당ㅎㅎ']
    },
    '격식있게': {
      '존댓말': ['은은한 향기와 함께 편안한 휴식이 되시길 바랍니다.', '좋은 향이 공간을 따뜻하게 채워주길 바랍니다.', '마음의 평안에 작은 도움이 되길 바랍니다.']
    }
  },
  '디지털': {
    '다정하게': {
      '반말': ['매일 요긴하게 잘 쓸 수 있을 것 같아서 골랐어!', '일상에서 자주 쓰면서 유용하게 활용해줘 :)', '네 생활에 편의를 더해줬으면 좋겠다!'],
      '존댓말': ['매일 요긴하게 잘 쓰실 수 있을 것 같아서 골랐어요!', '일상에서 자주 쓰시면서 유용하게 활용해주세요 :)', '생활에 편의를 더해드렸으면 좋겠어요!']
    },
    '담백하게': {
      '반말': ['실용적인 걸로 골라봤어.', '유용하게 잘 쓸 것 같아서 골라봤어.', '필요할 것 같아서 준비해봤어.'],
      '존댓말': ['실용적인 걸로 골라봤어요.', '유용하게 잘 쓰실 것 같아서 골라봤어요.', '필요하실 것 같아서 준비해봤어요.']
    },
    '장난스럽게': {
      '반말': ['이제 이거 없이는 못 사는 거 아니야?ㅋㅋ', '이거 쓰고 현대인 되자ㅋㅋ', '편하게 살자.'],
      '존댓말': ['이제 이거 없이는 못 사실지도 몰라요ㅋㅋ', '이거 쓰시면 완전 신문물이실 거예요ㅋㅋ', '편하게 지내시라고 골랐어요ㅋㅋ']
    },
    '격식있게': {
      '존댓말': ['일상과 업무에 유용하게 쓰이길 바라는 마음으로 준비했습니다.', '편리한 일상에 작은 보탬이 되길 바랍니다.', '생활에 작은 편리함을 더해드릴 수 있으면 좋겠습니다.']
    }
  },
  '홈': {
    '다정하게': {
      '반말': ['집에서 편하게 쓸 것 같아서 골라봤어!', '쉴 때 유용하게 쓸 것 같아서 골라봤어ㅎㅎ', '집에서 조금이라도 더 편했으면 해서 골라봤어.'],
      '존댓말': ['집에서 편하게 쓰실 것 같아서 골라봤어요!', '쉬실 때 유용하게 쓰실 것 같아서 골라봤어요ㅎㅎ', '집에서 조금이라도 더 편하셨으면 해서 골라봤어요.']
    },
    '담백하게': {
      '반말': ['집에 두고 쓰기에 제일 무난하고 편한 걸로 골랐어.', '필요할 것 같아서 하나 보냈어.', '방에 두면 좋을 것 같아서 골랐어.'],
      '존댓말': ['집에 두고 쓰기에 무난하고 편한 걸로 골랐어요.', '필요하실 것 같아서 하나 보내드려요.', '방에 두시면 좋을 것 같아서 골랐어요.']
    },
    '장난스럽게': {
      '반말': ['집순이/집돌이 생활에 한 걸음 더 다가가길ㅋㅋ', '집 밖으로 나오지 말고 힐링해라ㅋㅋ', '이제 약속 잡으면 이거 핑계로 거절하는 거 아니지?ㅋㅋ'],
      '존댓말': ['집순이/집돌이 생활에 한 걸음 더 다가가시길 바라용~~', '집에서 푹 쉬시라고 골라봤어요!!', '혹시 이거 핑계로 약속 거절하시는 거 아니죠?ㅎㅎ']
    },
    '격식있게': {
      '존댓말': ['편안하고 아늑한 휴식 시간에 작은 보탬이 되길 바랍니다.', '늘 평안한 공간이 되시길 바라는 마음으로 올립니다.', '기분 좋은 휴식이 되시길 바랍니다.']
    }
  },
  '식물': {
    '다정하게': {
      '반말': ['초록초록한 기운 받아서 늘 기분 좋은 하루 보내!', '보고 있으면 괜히 기분 좋아져서 골라봤어 🪴', '네 공간에 작은 활력이 되어줬으면 해!'],
      '존댓말': ['초록초록한 기운 받으시고 늘 기분 좋은 하루 보내세요!', '보고 있으면 괜히 기분 좋아져서 골라봤어요 🪴', '공간에 작은 활력이 되어드렸으면 해요!']
    },
    '담백하게': {
      '반말': ['키우기 무난하고 보기 좋은 걸로 골랐어.', '방이나 책상에 두고 키워봐.', '소소하게 힐링하기 좋을 거야.'],
      '존댓말': ['키우기 무난하고 보기 좋은 걸로 골랐어요.', '방이나 책상에 두고 키워보세요.', '소소하게 힐링하기 좋으실 거예요.']
    },
    '장난스럽게': {
      '반말': ['시들게 하지 말고 잘 키워라ㅋㅋ', '식물 보면서 눈 건강 좀 챙겨라ㅋㅋ', '죽이지 말고 오래오래 잘 키워라ㅋㅋ'],
      '존댓말': ['시들지 않게 잘 키워주시면 좋겠어요ㅎㅎ', '식물 보시면서 눈 건강도 챙기세요~!!', '오래오래 잘 키워주시길 바라용~!']
    },
    '격식있게': {
      '존댓말': ['화사하고 가릇한 기운이 늘 함께하시길 바랍니다.', '일상에 작은 싱그러움이 되길 바라는 마음입니다.', '늘 평안하시길 진심으로 기원합니다.']
    }
  },
  '문구': {
    '다정하게': {
      '반말': ['매일 손에 잡히는 걸로 부담 없이 챙겨봤어!', '일하거나 공부할 때 요긴하게 쓰였으면 좋겠다 :)', '평소에 잘 쓸 것 같아서 골라봤어. 예쁘게 잘 써줘ㅎㅎ'],
      '존댓말': ['매일 손에 잡히는 걸로 부담 없이 챙겨봤어요!', '일하시거나 공부하실 때 요긴하게 쓰였으면 좋겠어요 :)', '평소에 잘 쓰실 것 같아서 골라봤어요. 예쁘게 잘 써주세요ㅎㅎ']
    },
    '담백하게': {
      '반말': ['필요해 보이길래 하나 보내.', '매일 쓰기 무난한 할 것 같아 준비했어.', '실용적으로 쓰기 좋을 거야.'],
      '존댓말': ['필요해 보이셔서 하나 보내드려요.', '매일 쓰기 무난할 것 같아 준비했어요.', '실용적으로 쓰기 좋으실 거예요.']
    },
    '장난스럽게': {
      '반말': ['계획만 세우지 말고 실천도 해라ㅋㅋ', '너의 모든 기록을 응원한다ㅋㅋ', '이거 쓰고 정답만 찍어라/계약 성공해라!'],
      '존댓말': ['계획만큼 실천도 잘 되시길 바라요!!', '앞으로의 기록들 응원하겠습니당!!', '이거 쓰시고 좋은 결과만 있으시길 바라용!!']
    },
    '격식있게': {
      '존댓말': ['소중한 생각과 기록의 순간에 요긴히 쓰이길 바랍니다.', '노고와 열정의 순간에 작은 도움이 되길 바랍니다.', '늘 좋은 성과와 결실이 함께하시길 바랍니다.']
    }
  },
  '식품주류': {
    '다정하게': {
      '반말': ['달달한 거 먹고 기분 풀었으면 해서 골랐어!', '맛있는 거 먹고 힐링하는 시간이 되었으면 좋겠어😋', '맛있는 거 먹고 힘내라고 보내!'],
      '존댓말': ['달달한 거 드시고 기분 푸셨으면 해서 골랐어요!', '맛있는 거 드시고 힐링하는 시간이 되셨으면 좋겠어요😋', '맛있는 거 드시고 힘내시라고 보내드려요!']
    },
    '담백하게': {
      '반말': ['맛있게 먹고 기분 전환해.', '당 충전 필요할 때 먹으라고 골랐어.', '맛있게 즐기기 좋은 걸로 쐈다.'],
      '존댓말': ['맛있게 드시고 기분 전환하세요.', '당 충전 필요하실 때 드시라고 골랐어요.', '맛있게 즐기시기 좋은 걸로 준비했어요.']
    },
    '장난스럽게': {
      '반말': ['맛있게 먹으면 0칼로리인 거 알지?', '당 충전 빡 하고 힘내라! 😋', '먹고 죽은 귀신이 깔도 좋다더라 맛있게 먹어!'],
      '존댓말': ['맛있게 드시면 0칼로리인 거 아시죠??ㅎㅎ', '당 충전 제대로 하시고 힘내시길 바라요! 😋', '먹고 죽은 귀신이 때깔도 좋다잖아요, 맛있게 드세용!']
    },
    '격식있게': {
      '존댓말': ['풍요롭고 기분 좋은 휴식 시간이 되시길 바라는 마음입니다.', '맛있게 드시고 즐거운 시간 보내셨으면 좋겠습니다.', '소중한 분들과 행복한 시간 보내시는 데 작은 즐거움이 되었으면 좋겠습니다.']
    }
  },
  '건강': {
    '다정하게': {
      '반말': ['다른 것보다 네 건강이 제일 먼저 생각나서 챙겼어!', '피곤할 때 챙겨 먹고/쓰고 에너지 회복해 :)', '늘 건강하고 행복했으면 좋겠다!'],
      '존댓말': ['다른 것보다 건강이 제일 먼저 생각나서 챙겼어요!', '피곤하실 때 챙겨 드시고/쓰시고 에너지 회복하세요 :)', '늘 건강하고 행복하셨으면 좋겠어요!']
    },
    '담백하게': {
      '반말': ['체력 떨어지지 말고 건강 잘 챙겨.', '요즘 건강 챙기는 게 최고라 골랐어.', '몸 챙길 때 유용하게 활용해.'],
      '존댓말': ['체력 떨어지지 마시고 건강 잘 챙기세요.', '요즘 건강 챙기는 게 최고라 골랐어요.', '몸 챙기실 때 유용하게 활용하세요.']
    },
    '장난스럽게': {
      '반말': ['골골대지 말고 이거 먹고/쓰고 만수무강해라 👍', '건강이 최고다 체력 보충해라ㅋㅋ', '이거 먹고 건강해라ㅋㅋ'],
      '존댓말': ['이거 드시고/쓰시고 만수무강하시길 바라요 👍', '건강이 최고죠, 체력 든든히 챙기시길 바라요!', '이거 드시고 늘 건강하시길 바랍니당']
    },
    '격식있게': {
      '존댓말': ['항상 건강하시고 활기찬 날들만 가득하시길 진심으로 기원합니다.', '신체와 마음의 평안에 작은 보탬이 되길 바랍니다.', '늘 건강함 속에서 행복하시길 바랍니다.']
    }
  },
  '액세서리': {
    '다정하게': {
      '반말': ['너한테 잘 어울릴 것 같아서 골라봤어ㅎㅎ.', '포인트로 예쁘게 활용해주면 좋겠다 :)', '네 분위기랑 딱일 것 같아서 준비했어!'],
      '존댓말': ['잘 어울리실 것 같아서 골라봤어요ㅎㅎ', '포인트로 예쁘게 활용해주시면 좋겠어요 :)', '분위기랑 딱일 것 같아서 준비했어요!']
    },
    '담백하게': {
      '반말': ['데일리로 부담 없이 차고 다니기 좋을 거야.', '스타일에 포인트 줄 때 써.', '무난하게 잘 어울릴 것 같아서 골랐어.'],
      '존댓말': ['데일리로 부담 없이 착용하기 좋으실 거예요.', '스타일에 포인트 주실 때 써보세요.', '무난하게 잘 어울리실 것 같아서 골랐어요.']
    },
    '장난스럽게': {
      '반말': ['잃어버리지 말고 오래오래 써라ㅋㅋ', '착샷 인증 필수인 거 알지?ㅋㅋ', '꾸밀 때 잘 쓰고 다녀라ㅋㅋ'],
      '존댓말': ['잃어버리지 않으시고 오래오래 쓰시길 바랍니당~!', '착샷 인증 필수인 거 아시죠??ㅎㅎ', '꾸미실 때 예쁘게 잘 쓰고 다니셨으면 좋겠어용!ㅎㅎ']
    },
    '격식있게': {
      '존댓말': ['소중한 순간마다 함께할 수 있으면 좋겠습니다.', '마음에 드는 선물이 되었으면 좋겠습니다.', '일상에 작은 기쁨을 더해드리는 선물이 되었으면 좋겠습니다.']
    }
  },
  '패션': {
    '다정하게': {
      '반말': ['요즘 계절에 너한테 너무 잘 어울릴 것 같아!', '요즘 하고 다니면 잘 어울릴 것 같아서 골라봤어.', '보자마자 너 생각나서 골랐어 :) 잘 어울릴 것 같아서'],
      '존댓말': ['요즘 계절에 너무 잘 어울리실 것 같아요!', '요즘 하고 다니시면 잘 어울리실 것 같아서 골라봤어요.', '보자마자 생각나서 골랐어요 :) 잘 어울리실 것 같아서요']
    },
    '담백하게': {
      '반말': ['요즘 입기/착용하기 무난하고 실용적인 걸로 골랐어.', '데일리로 잘 써.', '스타일에 무난하게 잘 어울릴 거야.'],
      '존댓말': ['요즘 입으시기/착용하시기 무난하고 실용적인 걸로 골랐어요.', '데일리로 잘 쓰세요.', '스타일에 무난하게 잘 어울리실 거예요.']
    },
    '장난스럽게': {
      '반말': ['이거 입고/차고 사람답게 하고 다녀보자ㅋㅋ', '착샷 인증 바로 날려라ㅋㅋ', '잘 어울리면 내 안목 인정해줘라ㅋㅋ'],
      '존댓말': ['이거 입고/차고 멋지게 다니시길 바라요!', '착샷 인증 기대하고 있을게요!!', '잘 어울리면 제 안목도 인정해주시는 겁니다!']
    },
    '격식있게': {
      '존댓말': ['일상에 기분 좋은 포인트가 되었으면 좋겠습니다.', '기분 좋은 순간마다 함께할 수 있는 선물이 되었으면 좋겠습니다.', '마음에 드는 선물이 되었으면 좋겠습니다.']
    }
  },
  '상품권': {
    '다정하게': {
      '반말': ['갖고 싶은 거 골라서 기분 좋게 쓰라고 준비했어ㅎㅎ', '뭐가 좋을지 고민하다가 네가 원하는 걸 사는 게 좋을 것 같아서!', '필요한 거 살 때 조금이라도 도움이 되었으면 좋겠다.'],
      '존댓말': ['갖고 싶으신 거 골라서 기분 좋게 쓰시라고 준비했어요ㅎㅎ', '뭐가 좋을지 고민하다가 원하시는 걸 사시는 게 좋을 것 같아서요!', '필요하신 곳에 조금이라도 도움이 되었으면 좋겠어요.']
    },
    '담백하게': {
      '반말': ['뭐가 좋을지 고민하다가 상품권으로 골랐어.', '필요한 거 살 때 써.', '이게 제일 실용적인 것 같아서 골랐어.'],
      '존댓말': ['뭐가 좋을지 고민하다가 상품권으로 골랐어요.', '필요하신 곳에 쓰세요.', '이게 제일 실용적인 것 같아서 골랐어요.']
    },
    '장난스럽게': {
      '반말': ['원하는 거 골라서 시원하게 질러라ㅋㅋ', '내가 준 거니까 아낌없이 써라ㅋㅋ', '잊지말고 써라ㅋㅋ'],
      '존댓말': ['원하시는 거 골라서 시원하게 지르세요~!', '제가 드린 거니까 아낌없이 쓰시길 바라요~!', '잊지 마시고 꼭 쓰시길 바랍니당~']
    },
    '격식있게': {
      '존댓말': ['필요하신 곳에 유용하게 사용하셨으면 좋겠습니다.', '원하시는 곳에 기분 좋게 사용하시길 바랍니다.', '마음에 드는 것을 고르는 즐거움도 함께하시길 바랍니다.', '필요하신 곳에 알차게 사용하시길 바랍니다.']
    }
  }
};
